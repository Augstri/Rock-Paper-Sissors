...
var reader = (function (){var or__30987__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30987__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30987__auto__)){
return or__30987__auto__;
} else {
return (128);
...
var map__41904 = top_item;
var map__41904__$1 = ((((!((map__41904 == null)))?((((map__41904.cljs$lang$protocol_mask$partition0$ & (64))) || (map__41904.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41904):map__41904);
var file = cljs.core.get.call(null,map__41904__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__41904__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41904__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e41903){var _e = e41903;
return false;
}});
...
var temp__4657__auto___41906 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___41906)){
var sense_41907 = temp__4657__auto___41906;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_41907)].join('');
} else {
}
}
} else {
...
if(cljs.core.truth_((function (){var and__30975__auto__ = cljs.core.not.call(null,devtools.sanity_hints._STAR_installed_QMARK__STAR_);
...
//# sourceMappingURL=sanity_hints.js.map?rel=1487610715819