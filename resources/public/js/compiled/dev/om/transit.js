...
om.transit.TempIdHandler.cljs$lang$ctorPrWriter = (function (this__31593__auto__,writer__31594__auto__,opt__31595__auto__){
return cljs.core._write.call(null,writer__31594__auto__,"om.transit/TempIdHandler");
});
...
var args33792 = [];
var len__32057__auto___33795 = arguments.length;
var i__32058__auto___33796 = (0);
while(true){
if((i__32058__auto___33796 < len__32057__auto___33795)){
args33792.push((arguments[i__32058__auto___33796]));

var G__33797 = (i__32058__auto___33796 + (1));
i__32058__auto___33796 = G__33797;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33792.length)].join('')));
...
var args33799 = [];
var len__32057__auto___33802 = arguments.length;
var i__32058__auto___33803 = (0);
while(true){
if((i__32058__auto___33803 < len__32057__auto___33802)){
args33799.push((arguments[i__32058__auto___33803]));

var G__33804 = (i__32058__auto___33803 + (1));
i__32058__auto___33803 = G__33804;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33799.length)].join('')));
...
//# sourceMappingURL=transit.js.map?rel=1487610702305